...
blogsRouter.post('/' , requiredFieldsValidationMiddleware, bodyValidationMiddleware, inputValidationMiddleware,
...
blogsRouter.delete('/:id', inputValidationMiddleware, async (req: Request, res: Response) => {
